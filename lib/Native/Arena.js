...
class ArenaEntity extends Entity_1.Entity {
    ...
    spawnBoss() {
        if (this.game.gamemode == "ball" || this.game.gamemode == "crossroads" || this.game.gamemode == "sanctuary") { }
        else {
            const rand = Math.random();
            if (rand < .25) {
                const TBoss = [Fortress_1.default, Pyromancer_1.default, Mecha_1.default, Titan_1.default][~~(Math.random() * 4)];
                this.boss = new TBoss(this.game);
            }
            else {
                const TBoss = [Guardian_1.default, Protector_1.default, Beholder_1.default, Summoner_1.default, FallenOverlord_1.default, FallenPuker_1.default, FallenBooster_1.default, Defender_1.default][~~(Math.random() * 8)];
                this.boss = new TBoss(this.game);
            }
        }
    }
