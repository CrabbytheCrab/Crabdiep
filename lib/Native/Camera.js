...
class CameraEntity extends Entity_1.Entity {
    ...
    setLevel(level) {
        ...
        this.cameraData.levelbarMax = level < config_1.maxPlayerLevel ? 1 : 0;
        if (level <= config_1.maxPlayerLevel) {
            this.cameraData.score = (0, Enums_1.levelToScore)(level);
        ...
        if (Entity_1.Entity.exists(this.cameraData.values.player)) {
            ...
            if (this.cameraData.values.player instanceof TankBody_1.default) {
                ...
                if (newLevel < Enums_1.levelToScoreTable.length) {
                    const levelScore = (0, Enums_1.levelToScore)(this.cameraData.values.level);
                    this.cameraData.levelbarMax = (0, Enums_1.levelToScore)(this.cameraData.values.level + 1) - levelScore;
