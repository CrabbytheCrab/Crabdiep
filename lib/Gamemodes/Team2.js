...
class Teams2Arena extends Arena_1.default {
    constructor(game) {
        ...
        this.blueTeamBase = new TeamBase_1.default(game, new TeamEntity_1.TeamEntity(this.game, 6), -arenaSize + baseWidth / 2, 0, arenaSize * 2, baseWidth);
        this.redTeamBase = new TeamBase_1.default(game, new TeamEntity_1.TeamEntity(this.game, 5), arenaSize - baseWidth / 2, 0, arenaSize * 2, baseWidth);
        const dom1 = new Dominator_1.default(this, new TeamBase_1.default(game, this, arenaSize / 2.5, 0, domBaseSize * 2, domBaseSize, false));
        dom1.nameData.name = "East Dominator";
        const dom2 = new Dominator_1.default(this, new TeamBase_1.default(game, this, -arenaSize / 2.5, 0, domBaseSize * 2, domBaseSize, false));
