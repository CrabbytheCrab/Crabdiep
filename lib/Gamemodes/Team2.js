...
class Teams2Arena extends Arena_1.default {
    constructor(game) {
        ...
        new Dominator_1.default(this, new TeamBase_1.default(game, this, arenaSize / 2.5, 0, domBaseSize, domBaseSize, false));
        new Dominator_1.default(this, new TeamBase_1.default(game, this, -arenaSize / 2.5, 0, domBaseSize, domBaseSize, false));
        new MazeWall_1.default(this.game, -arenaSize / 2.5, -arenaSize / 5, domBaseSize * 3, domBaseSize);
        new MazeWall_1.default(this.game, arenaSize / 2.5, -arenaSize / 5, domBaseSize * 3, domBaseSize);
        new MazeWall_1.default(this.game, -arenaSize / 2.5, arenaSize / 5, domBaseSize * 3, domBaseSize);
        new MazeWall_1.default(this.game, arenaSize / 2.5, arenaSize / 5, domBaseSize * 3, domBaseSize);
