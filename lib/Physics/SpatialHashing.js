...
class SpatialHashing {
    ...
    retrieveEntitiesByEntity(entity) {
        const physics = entity.physics;
        const position = entity.position;
        return this.retrieve(position.x, position.y, entity.physics.values.sides === 2 ? entity.physics.values.size / 2 : entity.physics.values.size, entity.physics.values.sides === 2 ? entity.physics.values.width / 2 : entity.physics.values.size);
    }
    reset() {
        this.hashMap = new Map();
    }
