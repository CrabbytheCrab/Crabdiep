...
class Tool extends Live_1.default {
    constructor(barrel, tank, tankDefinition, shootAngle, mode, parent) {
        ...
        if (mode == 1) {
            this.minionBarrel = new Barrel_1.default(this, FT1);
            this.minionBarrel = new Barrel_1.default(this, FT2);
            this.minionBarrel = new Barrel_1.default(this, FT3);
        }
        else {
            this.minionBarrel = new Barrel_1.default(this, OS1);
            this.minionBarrel = new Barrel_1.default(this, OS2);
        }
