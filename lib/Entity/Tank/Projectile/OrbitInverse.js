...
class OrbitInverse extends Bullet_1.default {
    ...
    tick(tick) {
        ...
        if (this.fire == false) {
            ...
            let angle = util_1.PI2 * ((this.num) / this.parent.OrbCount2);
            const statLevels = this.tank.cameraEntity.cameraData?.values.statLevels.values;
            if (this.mode == 1) {
...
exports.default = OrbitInverse;
OrbitInverse.FOCUS_RADIUS = 850 ** 2;
OrbitInverse.MAX_RESTING_RADIUS = 400 ** 2;
OrbitInverse.BASE_ROTATION = 0.1;
OrbitInverse.dronecount = new Array(100);
