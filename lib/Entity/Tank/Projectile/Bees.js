...
class Bees extends Live_1.default {
    constructor(barrel, tank, tankDefinition, shootAngle, parent) {
        ...
        this.physicsData.values.size = tank.physicsData.values.size / 2;
        ...
        this.damagePerTick = (bulletDamage * 6 + 20) / 4;
    ...
    tick(tick) {
        ...
        const angle2 = Math.atan2(this.positionData.y - this.tank.inputs.mouse.y, this.positionData.x - this.tank.inputs.mouse.x);
...
exports.default = Bees;
Bees.FOCUS_RADIUS = 850 ** 2;
