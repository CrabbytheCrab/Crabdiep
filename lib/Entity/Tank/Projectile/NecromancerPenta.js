...
class NecromancerPentagon extends Drone_1.default {
    constructor(barrel, tank, tankDefinition, shootAngle) {
        ...
        this.styleData.values.color = tank.relationsData.values.team?.teamData?.values.teamColor || 18;
...
exports.default = NecromancerPentagon;
