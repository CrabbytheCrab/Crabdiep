...
exports.AddonById = exports.GuardObject2 = exports.GuardObject = exports.OverdriveAddon = exports.Addon = void 0;
...
class Addon {
    ...
    createAutoTurretsWeak(count) {
        ...
        if (rotator.styleData.values.flags & 1)
            rotator.styleData.values.flags ^= 1;
        for (let i = 0; i < count; ++i) {
            const base = new AutoTurret_1.default(this.owner, { ...AutoTurretMiniDefinition, reload: 1.5, delay: 0.25 });
            base.influencedByOwnerInputs = true;
    ...
    createAutoTurretsDisconnected(count) {
        ...
        if (rotator.styleData.values.flags & 64)
            rotator.styleData.values.flags |= 64;
        for (let i = 0; i < count; ++i) {
            const base = new AutoTurret_1.default(rotator, { ...AutoTurretMiniDefinition, reload: 1.2 });
